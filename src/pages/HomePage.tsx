import {ClipboardList, Flame, Leaf, Play, Search, Target} from 'lucide-react';
...
const browseCards = [
  {to: '/affiner', icon: Target, title: 'Me sculpter', desc: 'Galbe le muscle de tes zones — révèle-les en perdant du gras.'},
